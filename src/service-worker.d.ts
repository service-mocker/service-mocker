/*!
 * Since service worker API is currently work-in-progress,
 * and there're several mistakes in service_worker_api.d.ts,
 * we need to add interfaces manually.
 */
