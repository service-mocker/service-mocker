...
/***/ function(module, exports, __webpack_require__) {
	...
	var Server = exports.Server = function () {
	  function Server() {
	    ...
	    this._running = false;
	    this._clients = new Set([_constants.LEGACY_CLIENT_ID]);
	  ...
	  _createClass(Server, [{
	    key: 'test',
	    value: function () {
	      var _ref = _asyncToGenerator(_regenerator2.default.mark(function _callee(clientId) {
	        var client, setRes, getRes;
	            ...
	            switch (_context.prev = _context.next) {
	              ...
	              case 7:
	                ...
	                return (0, _utils.oneOffMessage)({
	                  target: client,
	                  message: {
	                    action: _constants.ACTION.SET_STORAGE,
	                    key: 'whoami',
	                    value: {
	                      name: 'Dolphin',
	                      date: new Date()
	              ...
	              case 10:
	                ...
	                return (0, _utils.oneOffMessage)({
	                  target: client,
	                  message: {
	                    action: _constants.ACTION.GET_STORAGE,
	                    key: 'whoami'
	                  }
	                });
	    ...
	    value: function _handleMessage() {
	      ...
	      self.addEventListener('message', function (evt) {
	        ...
	        switch (data.action) {
	          case _constants.ACTION.PING:
	            _this._clients.add(source.id);

	            return ports[0].postMessage({
	              action: _constants.ACTION.PONG
	            });

	          case _constants.ACTION.REQUEST_CLAIM:
	          ...
	          case _constants.ACTION.DISCONNECT:
	            return _this._clients.delete(source.id);
	        }
	      });
	    }
	  }, {
	    key: '_filterRequest',
	    value: function _filterRequest() {
	      var _this2 = this;
	      ...
	      self.addEventListener('fetch', function (evt) {
	        ...
	        if (clientId && !_this2._hasClient(clientId)) {
	          console.warn('unknown client: ' + clientId);
	          return;
	        }

	        _this2.test(clientId);
